...
void Application::PrintUsage()
{
	...
	else if (command == "pixelray" || command == "firsthit" || command == "pixelcolor")
	{
	...
	else if (command == "help")
	{
		...
		printf("        pixelcolor   print the shaded color for the given pixel\n");
	}
	else
	{
...
Scene * Application::LoadPovrayScene(const std::string & fileName)
{
	...
	for (const parser::Object & o : p.objects)
	{
		...
		case parser::Object::Type::Triangle:
			std::cerr << "Triangle objects not supported." << std::endl;
			break;
